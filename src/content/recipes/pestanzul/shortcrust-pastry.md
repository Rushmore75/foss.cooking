...
The ingredients below are roughly enough for an 8 slices [crostata](/recipe/crostata), but servings are reduced if the dough is used alone (e. g. for biscuits).
